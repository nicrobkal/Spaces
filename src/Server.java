...
{	
	...
	private static Building townHall;
	private static Building powerPlant;
	private static Building fields;
	private static Building warehouse;
	private static Building mine;
	private static Building fort;
	
	private static Skill farming;
	private static Skill thievery;
	private static Skill charisma;
	private static Skill combat;
	private static Skill mining;
	private static Skill computing;
	...
	public static void main(String[] args)
	{
	    ...
	    try
	    {
		    ...
		    frame.setIconImage(new ImageIcon("res\\SpacesServerIcon.png").getImage());
		...
		catch(Exception ex)
		{
			...
			townHall = new Building("Town Hall", "The central hub of town where you can perform various official matters. ");
			powerPlant = new Building("Power Plant", "The power plant of the town, where all the power is generated. ");
			fields = new Building("Fields", "The open fields of town, where crops are grown and animals are raised. ");
			warehouse = new Building("Warehouse", "The storage warehouse in town, where all of the town's resources are kept. ");
			mine = new Building("Mine", "The abundant mine in town, where people go to mine, and collect natural resources. ");
			fort = new Building("Fort", "The ancient fort in town occupied by monsters, and a good place to collect loot. ");
			
			farming = new Skill("Farming", "The ability to grow higher quality crops, and raise animals to make better products. ", null, fields);
			thievery = new Skill("Thievery", "The ability to steal without being caught, and pick locks of higher calibre. ", null, warehouse);
			charisma = new Skill("Charisma", "The ability to convince others to see your point of view, and have them like you more. ", null, townHall);
			combat = new Skill("Combat", "The ability to defend yourself as well as deal damage in a fight. ", null, fort);
			mining = new Skill("Mining", "The ability to find better ore and gems and craft better ingots. ", null, mine);
			computing = new Skill("Computing", "The ability to hack terminals and take their information. ", null, powerPlant);
			...
			spaceStats.setBuildingList(new Building[]{fort, mine, fields, townHall, warehouse, powerPlant});
