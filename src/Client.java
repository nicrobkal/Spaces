...
public class Client implements Serializable
{
	...
	public static ClientCommandListener clientCommandListener;
		...
		try
		{
			...
			while(!playerEntered)
			{
				...
				catch(Exception ex)
				{
					...
					localPlayer.skillList = spaceStats.spaceSkills;
					...
					localPlayer.createWelcomeEvent();
			...
			localPlayer.eventQueue.peek().startEvent();
		}
		catch(Exception ex)
		{
			ex.printStackTrace();
